...
public class CarServiceAnnotations {
    ...
    private static CarServiceAnnotations carServiceAnnotations = new CarServiceAnnotations();

    public static CarServiceAnnotations getInstance() {
        return carServiceAnnotations;
    }

    private CarServiceAnnotations() {
    }
